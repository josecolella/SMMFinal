...
/**
 * JMainFrame extiende <tt>JFramw</tt> y 
 * es el contenedor de la aplicación JMultiPlayer
 * Contiene los paneles y subcontenedores dentro
 * del frame.
 * 
 * @author Jose
 * @version 1.0
...
public class JMainFrame extends JFrame {
    ...
    //Atributo usado para guardar la imagen original
    private BufferedImage imgSource;

    /**
     * Crea el contenedor de la aplicacion donde estan todos los
     * otros paneles 
     */
    public JMainFrame() {
    ...
    private void initComponents() {
        ...
        jFilterComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Media", "Binomial", "Enfoque", "Relieve", "Laplaciano" }));
        jFilterComboBox.setToolTipText("Filtros de emborronamiento, enfoque, relieve, y fronteras");
        jFilterComboBox.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Filtro\n", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.ABOVE_TOP, null, new java.awt.Color(0, 0, 0)));
        jFilterComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jFilterComboBoxActionPerformed(evt);
            }
        });
        jPanel2.add(jFilterComboBox);
    ...
    /**
     * Devuelve la imagen en la cual se hace
     * una captura de pantalla
     * 
     * @param player
     * @return BufferedImage imagen capturada
     */
    ...
    /**
     * Convierte el tipo de imágen al tipo de imágen pasada
     * por parametro
     * 
     * @param img La imágen a cambiar
     * @param type El tipo de imágen a convertir
     * @return La nueva imágen
     */
    ...
    //La acción cuando se toca el botón nuevo
    private void jNewMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jNewMenuItemActionPerformed
        ...
        vi.setVisible(true);
        this.jStrokeColorButton.setBackground(Color.BLACK);
        if(this.jFillColorButton.isEnabled()) {
            this.jFillColorButton.setEnabled(false);
            this.jFillColorButton.setBackground(Color.BLACK);
        }
        if(this.jGradientFillRadioButton.isSelected())
        {
            this.jGradientFillRadioButton.setSelected(false);
            this.jFrontGradientButton.setBackground(Color.BLACK);
            this.jBackGradientButton.setBackground(Color.BLACK);
        }
        if(this.jEditCheckBox.isSelected())
        {
            this.jEditCheckBox.setSelected(false);
        }
        this.jNoFillRadioButton.setSelected(true);
        this.jStrokeSpinner.setValue(0);
         this.validate();
    }//GEN-LAST:event_jNewMenuItemActionPerformed

    //Metodo usado para verificar si es una extensión 
    ...
    //Metodo usado para verificar si es una extensión de video
    ...
    //Metodo que gestiona el evento de abrir
    ...
    //Metodo que gestiona el evento de guardar
    ...
    //Metodo que gestiona el evento del slider de brillo
    ...
    //Metodo que gestiona el evento de cuando se coge el foco del slider de brillo
    ...
    //Metodo que gestiona el evento de cuando se pierde el foco del slider de brillo
    ...
    //Metodo que gestiona el evento del como box de filtros
    ...
    //Metodo que gestiona el evento de contraste
    ...
    //Metodo que gestiona la iluminación
    ...
    //Metodo que gestiona la oscuridad
    ...
    //Metodo que gestiona el slider para la rotación
    ...
    //Metodo que gestiona el color de los botones que se usarán
    //para gestionar los colores de trazo y relleno
